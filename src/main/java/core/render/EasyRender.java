...
public class EasyRender {
    ...
    public final LineWithClip lineWithClip;
    public final Triangle triangle;
    public final TriangleWithClip triangleWithClip;
    public final Pixel pixel;
    public final PixelWithClip pixelWithClip;
    public final Image image;
    public final ImageWithClip imageWithClip;
    public final Point point;
    public final Text text;
    public final TextWithClip textWithClip;
    ...
    public class LineWithClip{
        ...
        public LineWithClip() {
            ...
            //====CREATE THE SHADER PROGRAM====//
            vertexShader = createShader("src/main/resources/shaders/lineWithClip/shader.vert", GL_VERTEX_SHADER);
            fragmentShader = createShader("src/main/resources/shaders/lineWithClip/shader.frag", GL_FRAGMENT_SHADER);
            shaderProgram = glCreateProgram();
            glAttachShader(shaderProgram, vertexShader);
            glAttachShader(shaderProgram, fragmentShader);
            glLinkProgram(shaderProgram);
            ...
            glEnableVertexAttribArray(1);
            glVertexAttribPointer(2, 4, GL_FLOAT, false, 11 * Float.BYTES, 7 * Float.BYTES);
         ...
         * @param a the alpha value of the line
         */
        public void drawLine2D(float x1, float y1, float x2, float y2, float r, float g, float b, float a, float clipX1, float clipY1, float clipX2, float clipY2){
            if(vertices.remaining() < 11 * 4 * 2){
                flush();
            }
            vertices.putFloat(x1);
            vertices.putFloat(y1);
            ...
            vertices.putFloat(b);
            vertices.putFloat(a);
            vertices.putFloat(clipX1);
            vertices.putFloat(clipY1);
            vertices.putFloat(clipX2);
            vertices.putFloat(clipY2);
            vertices.putFloat(x2);
            vertices.putFloat(y2);
            vertices.putFloat(0);
            vertices.putFloat(r);
         ...
         * @param a the alpha value of the line
         */
        public void drawLine3D(float x1, float y1, float z1, float x2, float y2, float z2, float r, float g, float b, float a, float clipX1, float clipY1, float clipX2, float clipY2){
            if(vertices.remaining() < 11 * 4 * 2){
                flush();
            }
            vertices.putFloat(x1);
    ...
    public class TriangleWithClip{
        ...
        public TriangleWithClip() {
            ...
            //====CREATE THE SHADER PROGRAM====//
            vertexShader = createShader("src/main/resources/shaders/triangleWithClip/shader.vert", GL_VERTEX_SHADER);
            fragmentShader = createShader("src/main/resources/shaders/triangleWithClip/shader.frag", GL_FRAGMENT_SHADER);
            shaderProgram = glCreateProgram();
            glAttachShader(shaderProgram, vertexShader);
            glAttachShader(shaderProgram, fragmentShader);
            glLinkProgram(shaderProgram);
         ...
         * @param a the alpha value of the triangle
         */
        public void drawTriangle2D(float x1, float y1, float x2, float y2, float x3, float y3, float r, float g, float b, float a, float clipX1, float clipY1, float clipX2, float clipY2){
            if(vertices.remaining() < 11 * 4 * 3){
                flush();
            }
            vertices.putFloat(x1);
            vertices.putFloat(y1);
         ...
         * @param a3 the alpha value of the third point
         */
        public void drawTriangle2D(float x1, float y1, float x2, float y2, float x3, float y3, float r1, float g1,
                                   float b1, float a1, float r2, float g2, float b2, float a2, float r3, float g3,
                                   float b3, float a3, float clipX1, float clipY1, float clipX2, float clipY2){
            if(vertices.remaining() < 11 * 4 * 3){
                flush();
            }
            vertices.putFloat(x1);
         ...
         * @param a the alpha value of the triangle
         */
        public void drawTriangle3D(float x1, float y1, float z1, float x2, float y2, float z2, float x3, float y3, float z3, float r, float g, float b, float a, float clipX1, float clipY1, float clipX2, float clipY2) {
            if (vertices.remaining() < 11 * 4 * 3) {
                flush();
            }
            vertices.putFloat(x1);
    ...
    public class PixelWithClip{
        ...
        public PixelWithClip() {
            ...
            //====CREATE THE SHADER PROGRAM====//
            vertexShader = createShader("src/main/resources/shaders/pixelWithClip/shader.vert", GL_VERTEX_SHADER);
            geometryShader = createShader("src/main/resources/shaders/pixelWithClip/shader.geom", GL_GEOMETRY_SHADER);
            fragmentShader = createShader("src/main/resources/shaders/pixelWithClip/shader.frag", GL_FRAGMENT_SHADER);
            shaderProgram = glCreateProgram();
            glAttachShader(shaderProgram, vertexShader);
            glAttachShader(shaderProgram, geometryShader);
            glAttachShader(shaderProgram, fragmentShader);
            ...
            glBufferData(GL_ARRAY_BUFFER, 1024 * 1024 * 6 * 4, GL_DYNAMIC_DRAW);
            vertices = glMapBuffer(GL_ARRAY_BUFFER, GL_WRITE_ONLY, 256 * 1024 * 6 * 4, vertices);
            glVertexAttribPointer(0, 2, GL_FLOAT, false, 10 * Float.BYTES, 0);
            glEnableVertexAttribArray(0);
            glVertexAttribPointer(1, 4, GL_FLOAT, false, 10 * Float.BYTES, 2 * Float.BYTES);
            glEnableVertexAttribArray(1);
            glVertexAttribPointer(2, 4, GL_FLOAT, false, 10 * Float.BYTES, 6 * Float.BYTES);
            glEnableVertexAttribArray(2);
            glBindBuffer(GL_ARRAY_BUFFER, 0);
            glBindVertexArray(0);
            glUseProgram(0);
        ...
        public void drawPixel(float x, float y, float r, float g, float b, float a, float clipX1, float clipY1, float clipX2, float clipY2){
            if(vertices.remaining() < 10 * 4){
                flush();
            }
            vertices.putFloat(x);
            vertices.putFloat(y);
    ...
    public class ImageWithClip{
        ...
        public ImageWithClip() {
            ...
            //====CREATE THE SHADER PROGRAM====//
            vertexShader = createShader("src/main/resources/shaders/imageWithClip/shader.vert", GL_VERTEX_SHADER);
            geometryShader = createShader("src/main/resources/shaders/imageWithClip/shader.geom", GL_GEOMETRY_SHADER);
            fragmentShader = createShader("src/main/resources/shaders/imageWithClip/shader.frag", GL_FRAGMENT_SHADER);
            shaderProgram = glCreateProgram();
            glAttachShader(shaderProgram, vertexShader);
            glAttachShader(shaderProgram, geometryShader);
            glAttachShader(shaderProgram, fragmentShader);
            ...
            glBindBuffer(GL_ARRAY_BUFFER, vbo);
            glBufferData(GL_ARRAY_BUFFER, vertices.capacity(), GL_DYNAMIC_DRAW);
            glVertexAttribPointer(0, 2, GL_FLOAT, false, 16 * Float.BYTES, 0);
            glEnableVertexAttribArray(0);
            glVertexAttribPointer(1, 2, GL_FLOAT, false, 16 * Float.BYTES, 2 * Float.BYTES);
            glEnableVertexAttribArray(1);
            glVertexAttribPointer(2, 4, GL_FLOAT, false, 16 * Float.BYTES, 4 * Float.BYTES);
            glEnableVertexAttribArray(2);
            glVertexAttribPointer(3, 4, GL_FLOAT, false, 16 * Float.BYTES, 8 * Float.BYTES);
            glEnableVertexAttribArray(3);
            glVertexAttribPointer(4, 4, GL_FLOAT, false, 16 * Float.BYTES, 12 * Float.BYTES);
         ...
         * @param sampler the sampler to use
         */
        public void drawImage(float x, float y, float width, float height, float r, float g, float b, float a, float s1, float t1, float s2, float t2, float clipX1, float clipY1, float clipX2, float clipY2, BufferedImage image, int sampler){
            flush();
            ByteBuffer buffer = MemoryUtil.memAlloc(image.getWidth() * image.getHeight() * 4);
            for (int j = image.getHeight()-1; j >=0; j--) {
                for (int i = 0; i < image.getWidth(); i++) {
            ...
            glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA8, image.getWidth(), image.getHeight(), 0, GL_RGBA, GL_UNSIGNED_BYTE, buffer);
            glBindTexture(GL_TEXTURE_2D, 0);
            drawTexture(x, y, width, height, r, g, b, a, s1, t1, s2, t2, clipX1, clipY1, clipX2, clipY2, texture, sampler);
        }
         ...
         * @param image the image to draw
         */
        public void drawImage(float x, float y, float width, float height, float r, float g, float b, float a, float s1, float t1, float s2, float t2, float clipX1, float clipY1, float clipX2, float clipY2, BufferedImage image){
            flush();
            ByteBuffer buffer = MemoryUtil.memAlloc(image.getWidth() * image.getHeight() * 4);
            for (int j = image.getHeight()-1; j >=0; j--) {
                for (int i = 0; i < image.getWidth(); i++) {
         ...
         * @param sampler the sampler to use
         */
        public void drawTexture(float x, float y, float width, float height, float r, float g, float b, float a, float s1,
                                float t1, float s2, float t2, float clipX1, float clipY1, float clipX2, float clipY2, int texture, int sampler){
            flush();
            glActiveTexture(GL_TEXTURE1);
            glBindTexture(GL_TEXTURE_2D, texture);
            glBindSampler(1, sampler);
            draw(x, y, width, height, r, g, b, a, s1, t1, s2, t2, clipX1, clipY1, clipX2, clipY2);
            glBindTexture(GL_TEXTURE_2D, 0);
            glBindSampler(1, 0);
            glActiveTexture(0);
        }
         ...
         */
        public void drawTexture(float x, float y, float width, float height, float r, float g, float b, float a, float s1,
                                float t1, float s2, float t2, float clipX1, float clipY1, float clipX2, float clipY2, int texture){
            drawTexture(x, y, width, height, r, g, b, a, s1, t1, s2, t2, clipX1, clipY1, clipX2, clipY2, texture, sampler);
        }
         ...
         * @param t2 the t2 value of the image
         */
        private void draw(float x, float y, float width, float height, float r, float g, float b, float a, float s1, float t1, float s2, float t2, float clipX1, float clipY1, float clipX2, float clipY2){
            vertices.putFloat(x).putFloat(y).putFloat(width).putFloat(height).putFloat(r).putFloat(g).putFloat(b).putFloat(a)
                    .putFloat(s1).putFloat(t1).putFloat(s2).putFloat(t2).putFloat(clipX1).putFloat(clipY1).putFloat(clipX2).putFloat(clipY2);
            vertexCount += 1;
            flush();
        }
    ...
    public class TextWithClip{
        ...
        public TextWithClip() {
            ...
            //====CREATE THE SHADER PROGRAM====//
            vertexShader = createShader("src/main/resources/shaders/textWithClip/shader.vert", GL_VERTEX_SHADER);
            geometryShader = createShader("src/main/resources/shaders/textWithClip/shader.geom", GL_GEOMETRY_SHADER);
            fragmentShader = createShader("src/main/resources/shaders/textWithClip/shader.frag", GL_FRAGMENT_SHADER);
            shaderProgram = glCreateProgram();
            glAttachShader(shaderProgram, vertexShader);
            glAttachShader(shaderProgram, geometryShader);
            glAttachShader(shaderProgram, fragmentShader);
            ...
            glBindBuffer(GL_ARRAY_BUFFER, vbo);
            glBufferData(GL_ARRAY_BUFFER, vertices.capacity(), GL_DYNAMIC_DRAW);
            glVertexAttribPointer(0, 4, GL_FLOAT, false, 16 * Float.BYTES, 0);
            glEnableVertexAttribArray(0);
            glVertexAttribPointer(1, 2, GL_FLOAT, false, 16 * Float.BYTES, 4 * Float.BYTES);
            glEnableVertexAttribArray(1);
            glVertexAttribPointer(2, 2, GL_FLOAT, false, 16 * Float.BYTES, 6 * Float.BYTES);
            glEnableVertexAttribArray(2);
            glVertexAttribPointer(3, 2, GL_FLOAT, false, 16 * Float.BYTES, 8 * Float.BYTES);
            glEnableVertexAttribArray(3);
            glVertexAttribPointer(4, 2, GL_FLOAT, false, 16 * Float.BYTES, 10 * Float.BYTES);
            glEnableVertexAttribArray(4);
            glVertexAttribPointer(5, 4, GL_FLOAT, false, 16 * Float.BYTES, 12 * Float.BYTES);
        ...
        public int[] drawTextRelative(float x, float y, float h, float r, float g, float b, float a, String text, Font font, float xCenter, float yCenter, float clipX1, float clipY1, float clipX2, float clipY2){
            Graphics2D g2d = new BufferedImage(1, 1, BufferedImage.TYPE_INT_ARGB).createGraphics();
            g2d.setFont(font);
            FontMetrics metrics = g2d.getFontMetrics(font);
            int width = metrics.stringWidth(text);
            ...
            draw(x - xCenter * h * width / height, y - yCenter * h, h * width / height, h, r, g, b, a, 0, 0, 1, 1, clipX1, clipY1, clipX2, clipY2);
         ...
         * @return the width and height of the text
         */
        public int[] drawTextLB(float x, float y, float h, float r, float g, float b, float a, String text, Font font, float clipX1, float clipY1, float clipX2, float clipY2) {
            Graphics2D g2d = new BufferedImage(1, 1, BufferedImage.TYPE_INT_ARGB).createGraphics();
            g2d.setFont(font);
            FontMetrics metrics = g2d.getFontMetrics(font);
            int width = metrics.stringWidth(text);
            ...
            draw(x, y, h * width / height, h, r, g, b, a, 0, 0, 1, 1, clipX1, clipY1, clipX2, clipY2);
         ...
         * @return the width and height of the text
         */
        public int[] drawTextLT(float x, float y, float h, float r, float g, float b, float a, String text, Font font, float clipX1, float clipY1, float clipX2, float clipY2) {
            Graphics2D g2d = new BufferedImage(1, 1, BufferedImage.TYPE_INT_ARGB).createGraphics();
            g2d.setFont(font);
            FontMetrics metrics = g2d.getFontMetrics(font);
            int width = metrics.stringWidth(text);
            ...
            draw(x, y - height, h * width / height, h, r, g, b, a, 0, 0, 1, 1, clipX1, clipY1, clipX2, clipY2);
         ...
         * @return the width and height of the text
         */
        public int[] drawTextRB(float x, float y, float h, float r, float g, float b, float a, String text, Font font, float clipX1, float clipY1, float clipX2, float clipY2) {
            ...
            draw(x - h * width / height, y, h * width / height, h, r, g, b, a, 0, 0, 1, 1, clipX1, clipY1, clipX2, clipY2);
         ...
         * @return the width and height of the text
         */
        public int[] drawTextRT(float x, float y, float h, float r, float g, float b, float a, String text, Font font, float clipX1, float clipY1, float clipX2, float clipY2) {
            ...
            draw(x - h * width / height, y - h, h * width / height, h, r, g, b, a, 0, 0, 1, 1, clipX1, clipY1, clipX2, clipY2);
         ...
         * @return the width and height of the text
         */
        public int[] drawTextLB(float x, float y, float h, float r, float g, float b, float a, String text, float clipX1, float clipY1, float clipX2, float clipY2){
            return drawTextLB(x, y, h, r, g, b, a, text, new Font(Font.MONOSPACED, Font.PLAIN, 16), clipX1, clipY1, clipX2, clipY2);
        }
         ...
         * @return the width and height of the text
         */
        public int[] drawTextLT(float x, float y, float h, float r, float g, float b, float a, String text, float clipX1, float clipY1, float clipX2, float clipY2){
            return drawTextLT(x, y, h, r, g, b, a, text, new Font(Font.MONOSPACED, Font.PLAIN, 16), clipX1, clipY1, clipX2, clipY2);
        }
         ...
         * @return the width and height of the text
         */
        public int[] drawTextRB(float x, float y, float h, float r, float g, float b, float a, String text, float clipX1, float clipY1, float clipX2, float clipY2){
            return drawTextRB(x, y, h, r, g, b, a, text, new Font(Font.MONOSPACED, Font.PLAIN, 16), clipX1, clipY1, clipX2, clipY2);
        }
         ...
         * @return the width and height of the text
         */
        public int[] drawTextRT(float x, float y, float h, float r, float g, float b, float a, String text, float clipX1, float clipY1, float clipX2, float clipY2){
            return drawTextRT(x, y, h, r, g, b, a, text, new Font(Font.MONOSPACED, Font.PLAIN, 16), clipX1, clipY1, clipX2, clipY2);
        }

        private void draw(float x1, float y1, float w, float h, float r, float g, float b, float a, float s1, float t1, float sl, float tl, float clipX1, float clipY1, float clipX2, float clipY2) {
            if (vertices.remaining() < 16 * 4) {
                flush();
            }
            vertices.putFloat(r).putFloat(g).putFloat(b).putFloat(a).putFloat(s1).putFloat(t1).putFloat(x1).putFloat(y1).putFloat(w).putFloat(h).putFloat(sl).putFloat(tl).putFloat(clipX1).putFloat(clipY1).putFloat(clipX2).putFloat(clipY2);
            vertexCount += 1;
        }
    ...
    public EasyRender(Window window) {
        this.window = window;
        line = new Line();
        lineWithClip = new LineWithClip();
        triangle = new Triangle();
        triangleWithClip = new TriangleWithClip();
        pixel = new Pixel();
        pixelWithClip = new PixelWithClip();
        image = new Image();
        imageWithClip = new ImageWithClip();
        point = new Point();
        text = new Text();
        textWithClip = new TextWithClip();
        glEnable(GL_BLEND);
    ...
    public void dispose(){
        line.dispose();
        lineWithClip.dispose();
        triangle.dispose();
        triangleWithClip.dispose();
        pixel.dispose();
        pixelWithClip.dispose();
        image.dispose();
        imageWithClip.dispose();
        point.dispose();
        text.dispose();
        textWithClip.dispose();
    }
}
